...
const Body: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 flex flex-col md:flex-row gap-4">
        {/* Left: Controls */}
      ...
      {/* Table at the bottom */}
      <div className={`mt-1 rounded-lg shadow p-6 relative z-10 container mx-auto px-4 ${darkMode ? "bg-gray-800 bg-opacity-80" : "bg-white bg-opacity-80"}`}>
